...
// GameUI's CAchievementDialog has a bug that won't let it show any achievement packs at all if theres only 1 present,
// so make another fake one (new achievement packs are counted every hundered IDs)
// In the localization file, the 1500 range will be localized as an empty string, so its less noticable
DECLARE_ACHIEVEMENT( CBaseAchievement, 1500, "DUMBASS_GAMEUI_HACK_PLEASE_IGNORE", 0 ); 
DECLARE_ACHIEVEMENT( CAchievementTFMedic_TopScoreboard, ACHIEVEMENT_TF_MEDIC_TOP_SCOREBOARD, "TF_MEDIC_TOP_SCOREBOARD", 5 );


//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_ChargeBySetupEnd : public CTFClassSpecificAchievement
{
	void Init() 
	{
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_HealTargetUnderFire : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_SimultaneousCharges : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_RapidUbercharges : public CTFClassSpecificAchievement
{
	void Init() 
	{
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_CounterUbercharges : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_SwitchToMedic : public CBaseAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
			...
			if ( m_flPreviousMedicCall && (gpGlobals->curtime - m_flPreviousMedicCall < 10.0) && bWantsMedic )
			{
				...
				if ( tf_PR )
				{
					...
					for( int playerIndex = 1; playerIndex <= MAX_PLAYERS; playerIndex++ )
					{
						...
						if ( tf_PR->GetPlayerClass( playerIndex ) == TF_CLASS_MEDIC )
						{
							bOnlyMedic = false;
							break;
						}
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_SaveTeammate : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_ChargeBlocker : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_AssistMedic : public CTFClassSpecificAchievement
{
	void Init() 
	{
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_KillScoutsWithSyringe : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL | ACH_LISTEN_KILL_EVENTS );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_KillMedicsWithBonesaw : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL | ACH_LISTEN_KILL_EVENTS );
...
class CAchievementTFMedic_AssistHeavyLongStreak : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL | ACH_LISTEN_KILL_EVENTS );
...
class CAchievementTFMedic_BaseAssistWhileCharged : public CTFClassSpecificAchievement
{
public:
	void Init() 
	{
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_HealEngineer : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_AssistPyro : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_AssistHeavy : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_AssistCapturer : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_HealCallers : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_ExtinguishTeammates : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_AssistVsNemeses : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL | ACH_LISTEN_KILL_EVENTS );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_KillWhileCharged : public CTFClassSpecificAchievement
{
	void Init() 
	{
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_BonesawNoMisses : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_HealLarge : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_HealHuge : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_HealGrind : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_KillHealedSpy : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_SaveFallingTeammate : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_ChargeJuggle : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_FreezecamRagdoll : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_BonesawSpyCallers : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL | ACH_LISTEN_PLAYER_KILL_ENEMY_EVENTS );
...
class CAchievementTFMedic_ChargeFriends : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
			...
			if ( event->GetInt( "medic_userid" ) == pLocalPlayer->GetUserID() && iTargetIndex > 0 )
			{
				...
				{	
					...
					if ( !bFound )
					{
						...
						{
							EUniverse universe = steamapicontext->SteamUtils()->GetConnectedUniverse();
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_InviteJoinCharge : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
...
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFMedic_HealAchiever : public CTFClassSpecificAchievement
{
	void Init() 
	{
		SetFlags( ACH_SAVE_GLOBAL );
