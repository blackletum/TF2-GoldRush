...
CCharacterInfoPanel* CharInfoPanel( void )
{
...
CCharacterInfoPanel::CCharacterInfoPanel( Panel* parent ) : PropertyDialog( parent, "character_info" )
{
	...
	// Stat summary
	m_pStatSummaryPanel = new CTFStatsSummaryPanel(  );
	m_pStatSummaryPanel->SetupForEmbedded();
	AddPage( m_pStatSummaryPanel, "#Stats" );
